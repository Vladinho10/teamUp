          ...
          <div className="user-avatar__logo-box">
            {
              this.props.user.photo
                ? <NavLink className="user-avatar__link" to={`/account/${this.props.user._id}`}><img className="user-avatar__logo" src={this.props.user.photo.slice(0,4) == 'https'?this.props.user.photo:'data:image/png;base64,'+this.props.user.photo} alt="User Photo" width="200" height="300" /></NavLink>
